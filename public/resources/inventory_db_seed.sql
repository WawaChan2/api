...
('Laptop Pro 15', 3500.00, 1, 'ELEC-001', 'High performance laptop', "http://api.com/public/images/laptop.jpg"),
('Wireless Mouse', 80.00, 1, 'ELEC-002', 'Ergonomic mouse', "http://api.com/public/images/wireless-mouse.webp"),

('Java Programming Book', 120.00, 2, 'BOOK-001', 'Learn Java from scratch', "http://api.com/public/images/java-textbook.jpg"),
('Algorithms Book', 150.00, 2, 'BOOK-002', 'Advanced algorithm concepts', "http://api.com/public/images/algorithms.png"),

('Office Chair', 450.00, 3, 'FURN-001', 'Comfortable ergonomic chair', "http://api.com/public/images/office-chair.webp"),
('Standing Desk', 900.00, 3, 'FURN-002', 'Height adjustable desk', "http://api.com/public/images/standing-desk.jpg"),

('T-Shirt Basic', 35.00, 4, 'CLOTH-001', 'Cotton t-shirt', "http://api.com/public/images/t-shirt.jpg"),
('Jeans Slim Fit', 120.00, 4, 'CLOTH-002', 'Modern slim jeans', "http://api.com/public/images/jeans.webp"),

('Instant Noodles', 5.00, 5, 'FOOD-001', 'Quick meal noodles', "http://api.com/public/images/instant-noodles.jpg"),
('Chocolate Bar', 8.00, 5, 'FOOD-002', 'Sweet chocolate snack', "http://api.com/public/images/chocolate-bar.jpg"),

('Oguri Plushie', 159.00, 6, 'OTHE-001', 'None other than the fatty', "http://api.com/public/images/oguri.jpg"),
('Tamamo Cross Plushie', 157.00, 6, 'OTHE-002', 'A legend but also a brokie', "http://api.com/public/images/tamamo.jpg");
